...
sudo git clone --depth 1 --branch 8.0 https://github.com/OCA/sale-workflow.git
sudo git clone --depth 1 --branch 8.0 https://github.com/OCA/vertical-medical.git
sudo git clone --depth 1 --branch 8.0 https://github.com/OCA/vertical-medical.git
sudo git clone --depth 1 --branch gh-pages https://github.com/luigisison/my_custom_addons
