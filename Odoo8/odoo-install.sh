#!/bin/bash
################################################################################
# Script for installing Odoo V8 on Ubuntu 14.04 LTS (could be used for other versions too)
...
#-------------------------------------------------------------------------------
# This script will install Odoo V8 on your Ubuntu 14.04 server.
...
# sudo wget https://raw.githubusercontent.com/luigisison/moxylus/master/Odoo9Community/odoo-install.sh
...
ttf-dejavu python-geoip python-pil -y
